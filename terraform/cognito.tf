...
resource "aws_cognito_user_pool" "main" {
  ...
  verification_message_template {
    ...
    email_message        = "Dojo: Your verification code is {####}"
    email_subject        = "Dojo Verification Code"
  }
  ...
  admin_create_user_config {
    ...
    invite_message_template {
      sms_message   = "Dojo Invitation. USR: {username} PWD: {####}  https://${var.application_subdomain}"
      email_subject = "Dojo Invitation"

      email_message = <<EOF
You have been added to the Dojo: https://${var.application_subdomain}
Username: {username}
Temporary Password: {####}
